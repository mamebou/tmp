...
public class UR5Controller : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        else
        {
            ...
            // GUI.Label(new Rect(10, 50, 150, 30), "Enter Psi (Degrees):");
            // stringPsi = GUI.TextField(new Rect(150, 50, 50, 25), stringPsi, 40);
            // GUI.Label(new Rect(10, 90, 100, 30), "Enter Y:");
            // stringY = GUI.TextField(new Rect(150, 90, 50, 25), stringY, 40);
            // GUI.Label(new Rect(10, 130, 150, 30), "Enter Theta (Degrees):");
            // stringTheta = GUI.TextField(new Rect(150, 130, 50, 25), stringTheta, 40);
            // GUI.Label(new Rect(10, 250, 100, 30), "Enter Z:");
            // stringZ = GUI.TextField(new Rect(150, 170, 50, 25), stringZ, 40);
            // GUI.Label(new Rect(10, 310, 150, 30), "Enter Phi (Degrees):");
            // stringPhi = GUI.TextField(new Rect(150, 170, 50, 25), stringPhi, 40);
        }

        if (GUI.Button(new Rect(10, 210, 50, 30), "Enter"))
            userHasHitOk = true;
    }
