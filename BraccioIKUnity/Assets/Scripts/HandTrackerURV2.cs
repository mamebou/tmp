...
public class HandTrackerURV2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mqtt = mqttManager.GetComponent<mqttForURV2>();
    ...
    void Update()
    {
        ...
        if(isBeforeMoveRobot == true && isStart == false && isFinishMove == true)
            beforeMoveRobot(); 
